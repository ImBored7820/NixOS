...

{
  wayland.windowManager.hyprland = {
    enable = true;
    # Since you are using the flake input, we keep the package as null
    # to use the version inherited from your flake-enabled system.
    package = null;
    portalPackage = null;
...
exec-once = waybar & hyprpaper & nwg-dock-hyprland -d -i 24 -p bottom -a center &
